...
export class StringInterpolator {
     ...
     */
    interpolate(value, context, options = {}) {
        const { strict = false, preserveTypes = true, allowPartial = true, defaultValue = undefined } = options;
        try {
     ...
     */
    interpolateObject(obj, context, options = {}) {
        try {
     ...
     */
    interpolateValue(value, context, options) {
        const errors = [];
        const warnings = [];
        if (typeof value === 'string') {
     ...
     */
    interpolateString(str, context, options) {
        const errors = [];
        const warnings = [];
        // Reset regex state
