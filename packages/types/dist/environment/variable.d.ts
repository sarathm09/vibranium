 ...
 * Variable types
 */
export type VariableType = 'string' | 'number' | 'boolean' | 'array' | 'object' | 'url' | 'email' | 'json' | 'base64' | 'file';
/**
 ...
 * Variable scope
 */
export type VariableScope = 'global' | 'scenario' | 'step' | 'session';
/**
 ...
 * Secret sources
 */
export type SecretSource = 'env' | 'file' | 'vault' | 'aws' | 'azure' | 'gcp' | 'custom';
/**
 * Secret transformation
 */
