 ...
 */
export type LifecycleEventType = 'scenario.start' | 'scenario.end' | 'scenario.failure' | 'step.before' | 'step.after' | 'step.failure' | 'api.before' | 'api.after' | 'dependencies.after';
/**
