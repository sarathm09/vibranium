...
export type ValidationOperator = 'equals' | 'notEquals' | 'contains' | 'notContains' | 'startsWith' | 'endsWith' | 'matches' | 'notMatches' | 'greaterThan' | 'greaterThanOrEqual' | 'lessThan' | 'lessThanOrEqual' | 'hasProperty' | 'hasLength' | 'isEmpty' | 'isNotEmpty' | 'isNull' | 'isNotNull' | 'isDefined' | 'isUndefined' | 'isType' | 'schema' | 'custom';
