...
export class EnvironmentValidator {
     ...
     */
    validateAgainstSchema(environment, schema) {
        const result = {
            valid: true,
            errors: [],
            warnings: []
     ...
     */
    validateVariableValue(value, schema, varName) {
        const result = {
            valid: true,
            errors: [],
            warnings: []
     ...
     * Check for circular references in variable interpolation
     */
    checkCircularReferences(variables) {
        const result = {
            valid: true,
            errors: [],
            warnings: []
     ...
     */
    containsHardcodedCredentials(value) {
