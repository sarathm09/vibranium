 ...
 */
export const defaultConfig: VibraniumConfig = {
  version: '1.0.0',
 ...
 */
export const devConfig: Partial<VibraniumConfig> = {
  logging: {
    level: 'debug',
    colors: true,
    format: 'simple'
 ...
 */
export const prodConfig: Partial<VibraniumConfig> = {
  logging: {
    level: 'warn',
    colors: false,
    format: 'json'
 ...
 */
export const ciConfig: Partial<VibraniumConfig> = {
  logging: {
    level: 'info',
    colors: false,
    format: 'json'
 ...
 */
export const testConfig: Partial<VibraniumConfig> = {
  timeout: 60000,
  retries: 5,
 ...
 * Load testing preset
 */
export const loadTestConfig: Partial<VibraniumConfig> = {
  timeout: 120000,
  retries: 1,
 ...
 */
export function getConfigPreset(name: string): Partial<VibraniumConfig> | null {
  return configPresets[name as keyof typeof configPresets] || null;
}
 ...
 */
export function createMinimalConfig(overrides: Partial<VibraniumConfig> = {}): VibraniumConfig {
  const minimal: VibraniumConfig = {
    defaultEnvironment: 'local',
    httpClient: 'got',
    timeout: 30000,
    retries: 3,
