...
/**
 * Common response handler to handle initial tasks
 * 
 * @param {DataStore} db The Database Object
 * @param {Request} req Express Js request object
 * @param {Response} res Express JS Response object
 * @param {function} handler The Handler function to be called after the initial tasks are done
 */
...
module.exports = async () => {
    ...
    app.listen(port, () => {
        ...
        if (error.code === 'EADDRINUSE') {
            console.error(`Could not start server at ${port}!`)
        }
    })
