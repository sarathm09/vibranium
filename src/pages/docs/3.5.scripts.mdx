---
title: Scripts
slug: /vibranium/docs/3.5.scripts
author: sarathm09
---
...
You can execute shell scripts and get the response from them using the `exec` function available in the scripts. Uses the promisified version of [Node exec](https://nodejs.org/api/child_process.html#child_process_child_process_exec_command_options_callback). Example:
```js
